...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-q0k=yj!f9ju+&@j!!bqgwd+m)$(ha73pj2xyr^g2hlp#5hnq!6')

DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',')

CORS_ALLOWED_ORIGINS = os.environ.get('ALLOWED_CORS', 'http://localhost,http://127.0.0.1').split(',')
