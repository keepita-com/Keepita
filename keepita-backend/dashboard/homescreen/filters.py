...
class HomeScreenLayoutFilter(django_filters.FilterSet):
    ...
    notification_panel_enabled = django_filters.BooleanFilter(
        field_name="notification_panel_enabled"
    )
    quick_access_enabled = django_filters.BooleanFilter(
        field_name="quick_access_enabled"
    )
...
class HomeScreenFolderFilter(django_filters.FilterSet):
    ...
    min_screen_index = django_filters.NumberFilter(
        field_name="screen_index", lookup_expr="gte"
    )
    max_screen_index = django_filters.NumberFilter(
        field_name="screen_index", lookup_expr="lte"
    )
...
class HomeScreenItemFilter(django_filters.FilterSet):
    ...
    package_name = django_filters.CharFilter(
        field_name="package_name", lookup_expr="icontains"
    )
...
class WallpaperFilter(django_filters.FilterSet):
    ...
    original_path = django_filters.CharFilter(
        field_name="original_path", lookup_expr="icontains"
    )
