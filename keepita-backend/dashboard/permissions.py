...
from dashboard.models import Backup, ClientInstance
...
class HasValidClientApiKey(BasePermission):
    def has_permission(self, request, view):
        ...
        try:
            client = ClientInstance.objects.get(key=api_key)
            return client.is_active
        except ClientInstance.DoesNotExist:
            return False