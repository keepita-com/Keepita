...
class WifiNetworkDetailSerializer(WifiNetworkSerializer):
    backup_phone_number = serializers.CharField(
        source="backup.phone_number", read_only=True
    )
    ...
    def get_security_strength(self, obj):
        ...
        return strength_mapping.get(
            obj.security_type, {"level": "Unknown", "color": "gray", "score": 50}
        )
