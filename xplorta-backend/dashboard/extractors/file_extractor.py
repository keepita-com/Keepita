    ...
    def extract(self) -> int:
        ...
        def process_file(file_path):
            ...
            try:
                ...
                try:
                    unique_filename = (
                        f"backup_{self.backup_id}_{file_count}_{file_path.name}"
                    )
                    ...
                    self.log_error(
                        f"Permission denied when processing file: {file_path}"
                    )
                except OSError as e:
                    self.log_error(
                        f"OS error when processing file: {file_path} - {str(e)}"
                    )
