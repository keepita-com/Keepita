...
class BluetoothDeviceFilter(django_filters.FilterSet):
    ...
    last_connected_after = django_filters.DateTimeFilter(
        field_name="last_connected", lookup_expr="gte"
    )
    last_connected_before = django_filters.DateTimeFilter(
        field_name="last_connected", lookup_expr="lte"
    )
